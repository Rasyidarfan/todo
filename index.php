...
<body>
  ...
  <div class="container">
    <div class="hero-unit">
      ...
      <h3>Kelas Santuy</h3><small> tapi ambis...</small>
    </div>
    ...
    <div class="row">
      <div class="span6">
        ...
        if(mysqli_num_rows($x) == 0) {
          echo "<tr>";
          echo "<td>Nggak ada tugas yey :-(</td>";
          echo "<td>-</td>";
          echo "<td>-</td>";
          echo "</tr>";
        }
          ...
          while($row = mysqli_fetch_array($x)) {
            $d = date('Y-m-d');
            if($d == $row['date']) {
              $display_date = '<p style="color:red;"><b>Hari ini woy</b></p>';
            }
            else {
        ...
        if(mysqli_num_rows($x) == 0) {
          ...
          while($row = mysqli_fetch_array($x)) {
            echo "<tr>";
            echo "<td><strike>".$row['matkul']."</strike></td>";
      ...
      <div class="span3">
        <form class="form-search form-myform" action="add_todo.php" method="post">
          <fieldset>
            <h3>Tambah tugas</h3>
            <div class="">
              <input class="input-block-level" type="text" name="matkul" placeholder="Matkul..." />
              <select class="input-block-level">
                <option>Default select</option>
              </select>
              <input class="input-block-level" type="text" name="desc" placeholder="Deskrip..." />
              <input class="input-block-level" type="text" name="date" placeholder="tanggal..." id="datepicker" />
